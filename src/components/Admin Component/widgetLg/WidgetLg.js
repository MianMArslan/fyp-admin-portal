      ...
      <table className="widgetLgTable">
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            ...
            />
            <span className="widgetLgName">Abdullah</span>
          </td>
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              ...
              className="widgetLgImg"
            />
            <span className="widgetLgName">Zaid</span>
          </td>
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              ...
              className="widgetLgImg"
            />
            <span className="widgetLgName">Zain</span>
          </td>
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              ...
              className="widgetLgImg"
            />
            <span className="widgetLgName">Arhum</span>
          </td>
